...
namespace DesignPatterns.Visitor
{
    public class FileSaveVisitor : ISaveEntitiyVisitor
    {
        ...
        {
            Console.WriteLine($"Saving [TYPE: {engine.GetType().Name} - POWER: {engine.Power}] to the file...");
        }

        public void Visit(IFuelSystem fuelSystem)
        {
            Console.WriteLine($"Saving [TYPE: {fuelSystem.GetType().Name} - CAPACITY: {fuelSystem.Capacity}] to the file...");
        }
